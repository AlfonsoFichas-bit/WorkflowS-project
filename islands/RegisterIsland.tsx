...
export default function RegisterIsland() {
  ...
  if (success) {
    return (
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 border border-gray-200 dark:border-gray-700">
        ...
        <p class="text-center text-gray-600 dark:text-gray-400 mb-6">Tu cuenta ha sido creada. Ahora puedes <a href="/login" class="font-medium text-primary hover:underline">iniciar sesión</a>.</p>
      </div>
    );
  }
  ...
  return (
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 border border-gray-200 dark:border-gray-700">
      <h1 class="text-2xl font-bold text-center text-primary mb-6">Crear Cuenta</h1>
      <form onSubmit={handleSubmit}>
        ...
        <div class="mb-4">
          <label class="block text-sm font-medium text-gray-700 mb-2" for="correo">Correo Electrónico</label>
          <input
            class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg focus:ring-primary focus:border-primary"
            id="correo"
            type="email"
        ...
        <div class="mb-4">
          <label class="block text-sm font-medium text-gray-700 mb-2" for="confirmContraseña">Confirmar Contraseña</label>
          <input
            class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg focus:ring-primary focus:border-primary"
        ...
        <p class="text-center text-sm text-gray-600 mt-6">
          ¿Ya tienes una cuenta? <a class="font-medium text-primary hover:underline" href="/login">Inicia sesión</a>
        </p>
      </form>
    </div>
  );
