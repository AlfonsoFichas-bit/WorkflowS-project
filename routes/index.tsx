        ...
        <header class="py-4 px-6 sm:px-16 lg:px-24">
          <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="flex items-center gap-2">
              <a class="px-4 py-2 rounded-lg text-sm font-bold bg-primary/10 dark:bg-primary/20 text-primary hover:bg-primary/20 dark:hover:bg-primary/30 transition-colors" href="/login">Iniciar Sesión</a>
            ...
            <div class="container mx-auto px-6 sm:px-16 lg:px-24 grid md:grid-cols-2 gap-12 items-center">
              <div class="flex flex-col gap-6 text-center md:text-left">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center md:justify-start mt-4">
                  ...
                  <a class="w-full sm:w-auto px-8 py-3 rounded-lg text-base font-bold bg-primary/10 dark:bg-primary/20 text-primary hover:bg-primary/20 dark:hover:bg-primary/30 transition-colors" href="/register">
                    Registrarse
                  </a>
                </div>
              </div>
